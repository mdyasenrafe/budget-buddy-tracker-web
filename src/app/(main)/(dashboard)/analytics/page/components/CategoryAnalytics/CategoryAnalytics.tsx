    ...
    >
      {isLoading ? (
        ...
        <div className="flex flex-col gap-5">
          <div className="grid grid-cols-1 items-center gap-5 xl:grid-cols-[1.08fr_0.92fr]">
            <div className="relative flex h-[320px] items-center justify-center rounded-2xl border border-slate-100 bg-[#F8FAFC]">
